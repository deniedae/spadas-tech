        ...
        <div className="space-y-2 border-b border-border pb-4">
          ...
          <div className="mt-4 rounded-2xl border border-indigo-500/30 bg-gradient-to-r from-indigo-950/80 via-slate-900 to-blue-950/80 p-5 space-y-4 shadow-xl">
            ...
            <div className="flex flex-wrap gap-2.5 pt-2 border-t border-white/10">
              <a
                href="/spadas-swoopa-extension.zip"
                download="spadas-swoopa-extension.zip"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-2.5 text-xs font-bold text-white shadow-md hover:opacity-90 transition cursor-pointer"
              >
                <Sparkles className="h-3.5 w-3.5" />
                <span>📥 Download Swoopa Chrome Extension (.zip)</span>
              </a>
