...
import { Calculator, ArrowLeft, DollarSign, TrendingUp, Sparkles, Percent, ShoppingBag, ShieldCheck, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-white p-4 sm:p-6 max-w-4xl mx-auto space-y-6 pb-24 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-400">eBay AU, Depop & FB Marketplace Fee Simulator</p>
        </div>
        <div className="w-10" />
      </div>
      ...
      <div className="rounded-3xl border border-cyan-500/40 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-6 shadow-2xl space-y-4">
        ...
        <div className="flex items-baseline justify-between">
          <div>
            ...
            <span className="text-sm font-bold text-slate-400 ml-2">AUD</span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-800 text-center">
          <div className="p-2.5 rounded-xl bg-slate-950/60 border border-slate-800/80">
            <span className="text-[10px] text-slate-400 uppercase font-bold block">Total In</span>
          ...
          <div className="p-2.5 rounded-xl bg-slate-950/60 border border-slate-800/80">
            <span className="text-[10px] text-slate-400 uppercase font-bold block">Cost of Goods</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800/80 space-y-2">
          <label className="text-xs font-bold text-slate-400 flex items-center justify-between">
            <span>Item Selling Price ($ AUD)</span>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800/80 space-y-2">
          <label className="text-xs font-bold text-slate-400 flex items-center justify-between">
            <span>Thrift Buy Price / COGS ($ AUD)</span>
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-r from-blue-900/30 via-slate-900 to-indigo-900/30 border border-blue-500/30 flex items-center justify-between gap-4">
        <div className="space-y-1">
          <span className="text-xs font-black text-cyan-300 uppercase tracking-wide">
            Want automated prices?
          </span>
          <p className="text-xs text-slate-300">
            Snap photos with Spadas Snap Studio and let AI detect sold comps & calculate profits automatically.
          </p>
        </div>
        <Link
          href="/studio"
